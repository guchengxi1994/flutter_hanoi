...
class HanoiForm extends StatefulWidget {
  const HanoiForm({super.key, required this.size});
  final Size size;

  @override
  State<HanoiForm> createState() => _HanoiFormState();
}

class _HanoiFormState extends State<HanoiForm> {
  List<String> types = [
    'easy',
    'normal',
    'hard',
    ...
    return MultiProvider(
        providers: [
          ChangeNotifierProvider(
              create: (_) => HanoiController()
                ..initPosition(Size(widget.size.width, widget.size.height)))
        ],
        builder: (ctx, child) {
          return Column(
